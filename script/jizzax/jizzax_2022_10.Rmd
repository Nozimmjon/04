...
```{r}
q1_reg <- reg_table(jizzax_input, q_1) %>% 
...
q2_reg <- reg_table(jizzax_input, q_2) %>% 
...
q3_reg <- reg_table(jizzax_input, q_3) %>% 
...
q4_reg <- reg_table(jizzax_input, q_4) %>% 
...
q5_reg <- reg_table(jizzax_input,q_5) %>% 
...
q6_reg <- reg_table(jizzax_input, q_6) %>% 
...
#Save Workbook
saveWorkbook(wb, "buxoro_indeks_2023_01.xlsx", overwrite = TRUE) 
```