...
```{r}
fergana_input_01 <- readxl::read_xlsx(here("data", "fergana.xlsx")) 
```
...
new_names <-   c("phone_number", "gender", "district", "age", 
                 ...
                 "q_4", "q_5", "q_6", "q_7", "q_8", "q_9", "education")
```
...
```{r}
 q_8 <-  fergana_input_02 %>%
  ...
  mutate(q_8 = recode(q_8, 
                      ...
                      "Электр таъминоти соҳаси" = "Электр таъминотида",
                       .default = "Бошқа")) %>% 
...
#Save Workbook
saveWorkbook(wb, "fergana_indeks_2023_01.xlsx", overwrite = TRUE) 
```
